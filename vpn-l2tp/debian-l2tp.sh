...
read -p "(Default PSK: ClangCN.com):" mypsk
if [ "$mypsk" = "" ]; then
	mypsk="ClangCN.com"
fi
...
apt-get -y update
apt-get -y upgrade
apt-get -y install make libgmp3-dev bison flex libpcap-dev ppp iptables gcc lsof vim
mkdir /ztmp
mkdir /ztmp/l2tp
cd /ztmp/l2tp
wget http://soft.clangcn.com/ftp/vpn-l2tp/openswan-2.6.24.tar.gz
...
ipsec verify
cd /ztmp/l2tp
wget http://soft.clangcn.com/ftp/vpn-l2tp/rp-l2tp-0.4.tar.gz
...
cd /ztmp/l2tp
wget http://soft.clangcn.com/ftp/vpn-l2tp/xl2tpd-1.2.4.tar.gz
